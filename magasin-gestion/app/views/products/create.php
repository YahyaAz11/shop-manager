...
<header class="page-header">
    ...
    <p class="page-header__desc">
        <?php if (!empty($supplierCatalogLock)): ?>
            Article proposé par votre entreprise <strong><?= htmlspecialchars($supplierCatalogLock['name']) ?></strong> — le magasin pourra le commander via un bon de commande.
        <?php else: ?>
            Renseignez les informations et le stock initial.
        <?php endif; ?>
    </p>
</header>
    ...
    <div class="panel__pad">
        <form method="post" action="index.php?action=product_store" class="form-grid form-grid--2">
            ...
            <div>
                ...
                <input id="vat_rate" name="vat_rate" type="number" step="0.01" min="0" max="100" value="20" title="Ex. 20 pour la TVA normale, 0 pour exonéré">
            </div>
            <div>
