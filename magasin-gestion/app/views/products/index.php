...
<header class="page-header">
    ...
    <p class="page-header__desc">Catalogue, prix et stocks. Recherchez par nom ou description.</p>
</header>
...
<div class="page-toolbar">
    ...
    <form method="get" action="index.php" class="toolbar-form">
        ...
        <input type="search" name="keyword" class="search-input" value="<?= htmlspecialchars($keyword) ?>" placeholder="Rechercher…" aria-label="Rechercher des produits">
