...
<div class="panel">
    <div class="panel__pad">
        <form method="post" action="index.php?action=user_update&id=<?= (int) $user['id'] ?>" class="form-grid form-grid--2">
            ...
            <div class="form-grid__full user-supplier-field-wrap<?= (string) $user['role'] === 'fournisseur' ? ' is-visible' : '' ?>" id="user-supplier-field-wrap">
                <label for="supplier_id">Entreprise fournisseur</label>
                ...
                <p class="text-muted" style="margin:0.35rem 0 0;font-size:0.88rem">Obligatoire pour un compte fournisseur — lien vers les bons de commande de cette entreprise.</p>
            </div>
